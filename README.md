...
page tells a focused story: revenue distribution across cities, customer lifetime value and loyalty patterns, rider efficiency vs earnings, and operational bottlenecks like undelivered orders and seasonal demand shifts.
Together, the SQL analysis and Power BI visualization layer make this a strong end-to-end portfolio piece that demonstrates data modeling, analytical thinking, DAX measure creation, and the ability to communicate insights to both technical and non-technical audiences.
